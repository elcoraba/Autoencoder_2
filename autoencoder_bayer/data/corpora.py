...
# Don't use! No minmax values and balancedHz available
...
class ETRA2019(EyeTrackingCorpus):
    ...
    def extract(self):      
        ...
        for subj in self.subjects:
            ...
            for stim in listdir(subj_dir):
                _, _, condition, stim_type, stim_file = stim.split('_')     #stimulus name: 009_002_Fixation_Natural_nat011 
        ...
        for subj in listdir(self.root):
            ...
            for phase, experiment in enumerate(mat['experiments'][:2]):
                ...
                for n, eye_data in enumerate(stimuli_data):
                    ...
                    self.timestep = list(eye_data['scan_t'].item()) - firstTimestep                         
