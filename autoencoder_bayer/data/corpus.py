...
class EyeTrackingCorpus:
    def __init__(self, args=None):
        if args:
            ...
            if self.slice_time_windows:
                ...
                print('1#############################################')
                print('viewing time in slice time, constructor ', self.viewing_time)
            else:
                self.viewing_time = args.viewing_time
                print('2#############################################')
                print('viewing time NOT in slice time, constructor ', self.viewing_time)
    ...
    def preprocess_data(self):
        ...
        print('3#############################################')
        print('viewing time ', self.viewing_time)
        print('sample limit ', sample_limit)
        # do you want to up or downsample?
